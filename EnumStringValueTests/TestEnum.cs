...
namespace EnumStringValueTests
{
  public enum TestEnum
  {
    ...
    [StringValue("4", true), StringValue("Four")] MultiDefinedWithPreferences,

    [StringValue("5", true), StringValue("Five", true)] MultiDefinedWithMultiplePreferences,
  ...
  public enum TestEnum_Secondary
  {
    ...
    [StringValue("4", true)] SingleDefinedWithPreferences,

    [StringValue("1"), StringValue("Four")] MultiDefined,

    [StringValue("5", true), StringValue("Three")] MultiDefinedWithPreferences,

    [StringValue("2", true), StringValue("Five", true)] MultiDefinedWithMultiplePreferences,
  }
}